...
import IDL from "../../target/idl/limo.json";
import { BN, web3 } from "@coral-xyz/anchor";
import { SYSVAR_INSTRUCTIONS_PUBKEY } from "@solana/web3.js";
import { Limo } from "../../target/types/limo";
import { findLargestTokenAccount, generateRandomLimoAccounts } from "./utils";
import {
  Price,
...
export type GlobalConfigAccount = anchor.IdlAccounts<Limo>["globalConfig"];
export type OraclePoolAccount = anchor.IdlAccounts<Limo>["oraclePoolsState"];
export type OrderAccount = anchor.IdlAccounts<Limo>["order"];

export class LimoHelper extends TransactionSender {
    public readonly program: anchor.Program<Limo>;
    ...
    constructor(
        ...
        this.program = new anchor.Program(IDL as anchor.Idl, PROGRAM_ID, provider) as anchor.Program<Limo>;
